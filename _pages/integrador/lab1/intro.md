...
<center>
<br/>
<img src='/images/integrador/lab1/rele.png'>
<p>Figura 1-Rele no Estado em Repouso (esquerda) e estado do Rele com corrente elétrica sobre a bobina (direita)</p>
</center>
...
<center>
<br/>
<img src='/images/integrador/lab1/ligacao_errada.png'>
</center>
...
<center>
<br/>
<img src='/images/integrador/lab1/transistor.png'>
<p>Figura 2-Transistor BJT NPN como chave</p>
</center>

A figura 3 mostra o detalhamento da figura anterior, Caso o resistor da base esteja ligado ao terra, não existe corrente elétrica fluindo em Ib. Neste cenário podemos simplificar a analisando dizendo que os contatos CE do transistor estão abertos, o que impede a passagem da corrente na cargagenérica Z. Agora, se colocarmos 5V no resistor de base surge uma corrente em Ib, o que idealmente transforma o contato CE do transistor em um curto circuitoe fazendo surgir uma corrente elétrica sobre a carga Z.


<center>
<br/>
<img src='/images/integrador/lab1/detalhamento_transistor.png'>
<p>Figura 3-Detalhamento do Circuito da Figura 2 conforme o sinal da base.</p>
</center>

Retornando ao problema do acionamento da bobina do Rele sendo comandada por um sinal de um microcontrolador, podemos utilizar o transistor BJT NPN conforme o diagrama da figura 4. Caso o Pino 1 esteja em 0V, não haverá a corrente I e o Rele estará desativado. Caso o estado do Pino seja invertido (5 V), o transistor atua como uma chave fechada e a bobina do Rele será energizada.

<center>
<br/>
<img src='/images/integrador/lab1/ligacao_bobina.png'>
...
<center>
<br/>
<img src='/images/integrador/lab1/display.png'>
<p>Figura 5-Esquemático de Display 7-segmentos Câtodo comum e Anodo Comum</p>
</center>

É utilizando um display 7-segmentos Catodo comum, podemos ligar ao cada um de seus segmentos a uma porta específica do Arduino. Acionamento corretamente as portas será possível mostrar o número desejado noDisplay. Por exemplo, para mostrarmos o número ‘3’ devemos acionar os segmentos ‘a’, ‘b’, ‘c’, ‘d’, ‘g’. Isso correponde a jogarmos em nível lógico os Pinos 0, 1, 2, 3 e 6 do Arduino.

<center>
<br/>
<img src='/images/integrador/lab1/ligacao_display.png'>
